...
class TCalendar(TortoiseBaseModel):
    shiftdate = fields.DateField(source_field='ShiftDate', primary_key=True)  # Field name made lowercase.
...
class TCheckqty(TortoiseBaseModel):
    noid = fields.IntField(source_field='NOID', primary_key=True)  # Field name made lowercase.
...
class TForecastsplit(TortoiseBaseModel):
    ...
    itemid = fields.IntField(source_field='ItemID', primary_key=True)  # Field name made lowercase.
...
class TGroupcolor(TortoiseBaseModel):
    groupno = fields.CharField(source_field='GroupNo', primary_key=True, max_length=32)  # Field name made lowercase.
...
class TMaterial(TortoiseBaseModel):
    materialno = fields.CharField(source_field='MaterialNo', primary_key=True, max_length=64, description='物料')  # Field name made lowercase.
...
class TMold(TortoiseBaseModel):
    moldno = fields.CharField(source_field='MoldNo', primary_key=True, max_length=32)  # Field name made lowercase.
...
class TOrderstatus(TortoiseBaseModel):
    orderno = fields.CharField(source_field='OrderNo', primary_key=True, max_length=64)  # Field name made lowercase.
...
class TPlangroup(TortoiseBaseModel):
    planitem = fields.CharField(source_field='PlanItem', primary_key=True, max_length=32)  # Field name made lowercase.
...
class TPlanlog(TortoiseBaseModel):
    planno = fields.IntField(source_field='PlanNo', primary_key=True)  # Field name made lowercase.
...
class TPlanner(TortoiseBaseModel):
    planner = fields.CharField(source_field='Planner', primary_key=True, max_length=8)  # Field name made lowercase.
...
class TPriority(TortoiseBaseModel):
    priortyno = fields.CharField(source_field='PriortyNo', primary_key=True, max_length=16)  # Field name made lowercase.
...
class TSortfield(TortoiseBaseModel):
    sortname = fields.CharField(source_field='SortName', primary_key=True, max_length=32)  # Field name made lowercase.
...
class TSyslog(TortoiseBaseModel):
    idno = fields.IntField(source_field='IDNo', primary_key=True)  # Field name made lowercase.
...
class TSyspara(TortoiseBaseModel):
    paraid = fields.CharField(source_field='ParaID', primary_key=True, max_length=32)  # Field name made lowercase.
...
class TTimepara(TortoiseBaseModel):
    timeno = fields.CharField(source_field='TimeNo', primary_key=True, max_length=8)  # Field name made lowercase.
...
class TType(TortoiseBaseModel):
    type = fields.CharField(source_field='Type', primary_key=True, max_length=8)  # Field name made lowercase.
...
class TVendor(TortoiseBaseModel):
    vendorno = fields.CharField(source_field='VendorNo', primary_key=True, max_length=64)  # Field name made lowercase.
...
class TWorkcenter(TortoiseBaseModel):
    workcenter = fields.CharField(source_field='WorkCenter', primary_key=True, max_length=32)  # Field name made lowercase.
    workcentername = fields.CharField(source_field='WorkCenterName', max_length=255, blank=True, null=True)  # Field name made lowercase.
...
class TWorkcenteruser(TortoiseBaseModel):
    username = fields.CharField(primary_key=True, max_length=255, description='用户名')
