...
class AcceptMatWcBom(BaseModel):
    ...
    matver: str = Field(..., alias=fc.t_mat_wc_bom.get("MatVer", "matver"), max_length=4, description='产线版本')
    ...
    offsethour: int = Field(..., alias=fc.t_mat_wc_bom.get("OffsetHour", "offsethour"), description='偏置+/-(小时)')
